  ...
  return (
    <main className="min-h-screen bg-background pt-12">
      <Section>
        ...
        >
          <span className="text-foreground">Insights &</span> <span className="text-gradient-primary">Updates.</span>
        </motion.h1>
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center opacity-50">
          ...
          <p className="text-foreground/60">Check back later for peace time news, press releases, and insights.</p>
        </div>
      </Section>
    </main>
  );
