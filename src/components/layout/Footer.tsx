          ...
          <div className="flex flex-col items-center md:items-end gap-3">
            {showSocials && (
              <div className="flex items-center gap-3">
                {/* TikTok */}
                <a href="#" className="w-8 h-8 rounded-lg bg-foreground/[0.05] border border-border flex items-center justify-center text-foreground-muted hover:text-foreground hover:border-foreground-muted transition-all duration-200">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z"/>
                  </svg>
                </a>
                {/* Discord */}
                <a href="#" className="w-8 h-8 rounded-lg bg-foreground/[0.05] border border-border flex items-center justify-center text-foreground-muted hover:text-[#5865F2] hover:border-[#5865F2]/40 transition-all duration-200">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
